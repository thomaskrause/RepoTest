...
class TestThatFailingWorksIgnoreMePlease(unittest.TestCase):
    def setUp(self):
    ...
    def test_that_failing_works_ignore_me_please(self):
        driver = self.driver
        driver.get(self.base_url + "/repository/")
        driver.find_element_by_link_text("Browse").click()
        driver.find_element_by_link_text("KAJUK").click()
        driver.find_element_by_css_selector("#ex2-node-1 > td").click()
