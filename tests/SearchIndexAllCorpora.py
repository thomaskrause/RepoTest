...
class SearchIndexAllCorpora(unittest.TestCase):
    ...
    def test_search_index_all_corpora(self):
        ...
        self.assertTrue(self.is_element_present(By.LINK_TEXT, "Deutsch Diachron Digital - Referenzkorpus Altdeutsch (1)"))
        ...
        self.assertTrue(self.is_element_present(By.LINK_TEXT, "RIDGES Herbology Version 4.1 (1)"))
