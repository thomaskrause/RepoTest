...
class BrowseAllCorpora(unittest.TestCase):
    ...
    def test_browse_all_corpora(self):
        ...
        self.assertTrue(self.is_element_present(By.LINK_TEXT, "Heliand"))
        self.assertTrue(self.is_element_present(By.LINK_TEXT, "Ludolf"))
        self.assertTrue(self.is_element_present(By.LINK_TEXT, "Muspilli"))
        self.assertTrue(self.is_element_present(By.LINK_TEXT, "SaechsischeWeltchronik"))
